...
router.get('',function (req,res,next){
    ...
    db.getClient().then((client) =>{
        ...
        client.query(query1,values1).then((result1 => {
            ...
            let query2 = 'SELECT fe.id,fe.user_id,fe.name,fe.amount::numeric,fe.status FROM fee fe WHERE fe.group_id = $1 AND fe.user_id = $2 ORDER BY fe.id ASC';
...
router.get('',function (req,res,next){
    ...
    db.getClient().then((client) =>{
        ...
        client.query(query1,values1).then((result1 => {
            ...
            let query2 = 'SELECT fe.id,fe.user_id,fe.name,fe.amount::numeric,fe.status FROM fee fe WHERE fe.group_id = $1 ORDER BY fe.id ASC';
...
router.get('',function (req,res){
    ...
    console.log(req.query);
    db.getClient().then((client) =>{
        let query1 = 'SELECT fe.id,fe.user_id,fe.name,fe.amount::numeric,fe.status FROM fee fe WHERE fe.user_id = $1 ORDER BY fe.id ASC';
